...
const COURSES = [
  ...
  { id: "pmp-prep", title: "تخليص اجراءات البيشايد", desc: "بنعمل البيشايد في اسرع وقت وباسعار مميزة", price: "تختلف حسب الولاية", duration: "شهر - شهرين", mode: "تسليم في المقر", image: "img_pmp-prep.svg"},
